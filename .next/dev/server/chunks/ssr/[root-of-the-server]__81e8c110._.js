...
function AuthProvider({ children }) {
            ...
            try {
                ...
                if (savedToken) {
                    ...
                    try {
                        ...
                        const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].me();
    ...
    const signup = async (data)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].signup(data);
    ...
    const login = async (data)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].login(data);
            localStorage.setItem('token', response.token);
            setToken(response.token);
            setUser(response.user);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81e8c110._.js.map